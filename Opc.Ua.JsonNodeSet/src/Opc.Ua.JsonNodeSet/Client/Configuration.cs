...
namespace Opc.Ua.JsonNodeSet.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "1.504.1";
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("OpenAPI-Generator/1.504.1/csharp");
            BasePath = "https://webapi.opcfoundation.org/api/nodeset";
            ...
            {
                {
                    new Dictionary<string, object> {
                        {"url", "https://webapi.opcfoundation.org/api/nodeset"},
        ...
        public Configuration(
            ...
            string basePath = "https://webapi.opcfoundation.org/api/nodeset") : this()
        {
        ...
        {
            string report = "C# SDK (Opc.Ua.JsonNodeSet) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: 1.0.0\n";
            report += "    SDK Package Version: 1.504.1\n";
